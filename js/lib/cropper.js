...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('study/JavaScript/Object-oriented-combat/move_menu/js/jquery')) :
  typeof define === 'function' && define.amd ? define(['study/JavaScript/Object-oriented-combat/move_menu/js/jquery'], factory) :
  (factory(global.$));
...
function getimages1ize(image, callback) {
...
var Cropper = function () {
  ...
  createClass(Cropper, [{
    ...
    value: function start() {
      ...
      getimages1ize($image[0], function (naturalWidth, naturalHeight) {
        $.extend(self.image, {
          naturalWidth: naturalWidth,
          naturalHeight: naturalHeight,
