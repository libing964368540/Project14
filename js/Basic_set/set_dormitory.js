        ...
        _m.add = function () {
            $('#addWeek').unbind('click').bind('click', function () {
                var index = parent.layer.open({
                    ...
                    '<li class="clear self_Mask_row"><label class="layui-form-label" style="width:60px;text-align:left;padding:9px 0;">寝室号</label><input class="layui-input rg" type="number"  placeholder="请输入寝室号"style="width:220px;background: #f3f5f8;border: none"  name="number" id="" lay-verify="required"></li>' +
